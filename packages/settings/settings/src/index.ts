...
/**
 * Brand a raw string as a {@link SettingsNamespace}. Runtime validation:
 * lowercase kebab-case, as in plugin short names. Public helper for consumers
 * (e.g. dsh-univer-office) that import the branded-namespace function directly.
 * @param value - candidate namespace; must match `/^[a-z][a-z0-9-]*$/`.
 * @returns the branded namespace.
 * @throws {TypeError} when `value` does not match the pattern.
 */
